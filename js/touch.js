...
$(function() {
	...
	$('#container-Frequency').highcharts({
		chart: {
			marginTop: 40
		},
		title: {
		...
		xAxis: {
			categories: ['<span class="hc-cat-title">频率</span><br/> HZ']
		},
		yAxis: {
			floor: 2,
			min:2,
...
//单条曲线图
function initSingleScatterCurveChart(pointdata, title, divid, xtext, ytext, color) {
    var mychart = new Highcharts.Chart({
        chart: {
            type: 'scatter', // 散点图   
            renderTo: divid,
...
function initMultiScatterCurveChart(series, title, divid, xtext, ytext) {
    var mychart = new Highcharts.Chart({
        chart: {
            type: 'scatter', // 散点图   
            renderTo: divid,
...
function initMultiSplineCurveChart(series, categories, title, divid, xtext, ytext) {
    var mychart = new Highcharts.Chart({
        chart: {
            type: 'spline',
            renderTo: divid,
...
function initMultiSplineCurveChart2() {
    var mychart = new Highcharts.Chart({
        chart: {
            type: 'scatter',
            renderTo: "HighYieldWellCurveDiv",
            zoomType: 'xy'
        },
        colors: ['#00ff00', '#ff0000', '#ff8000', '#ff0000', '#295d03', '#032871', '#6d036d', '#cc0000', '#00ff00'],
        title: {
            text: null,
            x: -20
        },
        ...
        series: [{
            ...
            name: '产液量',
            lineWidth: 3,
            data: [[0, null], [10, 15], [20, 40], [30, 68], [40, 85], [50, 95], [60, 100], [70, 106], [80, 107], [90, 107], [100, 107]]
        }, {
            yAxis: 0,
            name: '产油量',
            lineWidth: 3,
            data: [[0, null], [10, 2.25], [20, 6], [30, 10.2], [40, 12.75], [50, 14.25], [60, 15], [70, 15.9], [80, 16.05], [90, 16.05], [100, 16.05]]
        }, {
            yAxis: 0,
            name: '产水量',
            lineWidth: 3,
            data: [[0, null], [10, 12.75], [20, 34], [30, 57.8], [40, 72.25], [50, 80.75], [60, 85], [70, 90.1], [80, 90.95], [90, 90.95], [100, 90.95]]
        }, {
            yAxis: 1,
            name: '产出价值',
            lineWidth: 3,
            data: [[0, null], [10, 4526.7], [20, 12071.2], [30, 20521], [40, 25651.2], [50, 28669], [60, 30177.9], [70, 31988.6], [80, 32290.4], [90, 32290.4], [100, 32290.4]]
        }, {
            yAxis: 2,
            name: '电费',
            lineWidth: 3,
            data: [[0, null], [10, 36.5], [20, 58.4], [30, 87.6], [40, 124.1], [50, 153.3], [60, 185.2], [70, 229.8], [80, 275.1], [90, 400.6], [100, 540.9]]
        }, {
            yAxis: 2,
            name: '原油处理成本',
            lineWidth: 3,
            data: [[0, null], [10, 18], [20, 48], [30, 81.6], [40, 102], [50, 114], [60, 120], [70, 127.2], [80, 128.4], [90, 128.4], [100, 128.4]]
        }, {
            yAxis: 2,
            name: '作业维护成本',
            lineWidth: 3,
            data: [[0, null], [10, 6.5], [20, 7], [30, 7.5], [40, 8.5], [50, 10], [60, 12], [70, 50], [80, 100], [90, 200], [100, 400]]
        }, {
            yAxis: 2,
            name: '总成本',
            lineWidth: 3,
            data: [[0, null], [10, 61], [20, 113.4], [30, 176.7], [40, 234.6], [50, 277.3], [60, 317.2], [70, 407], [80, 503.5], [90, 729], [100, 1069.3]]
        }, {
            yAxis: 3,
            name: '利润',
            lineWidth: 3,
            data: [[0, null], [10, 4465.7], [20, 11957.8], [30, 20344.3], [40, 25416.6], [50, 28391.7], [60, 29860.7], [70, 31581.6], [80, 31786.5], [90, 31561.4], [100, 31221.1]]
        }],
        credits: {
            enabled: false
        }
...
function initMultiSplineCurveChart3() {
    var mychart = new Highcharts.Chart({
        chart: {
            type: 'scatter',
            renderTo: "LowYieldWellCurveDiv",
            zoomType: 'xy'
        },
        colors: ['#00ff00', '#ff0000', '#ff8000', '#ff0000', '#295d03', '#032871', '#6d036d', '#cc0000', '#00ff00'],
        title: {
        ...
        series: [{
            ...
            name: '产液量',
            lineWidth: 3,
            data: [[0, null], [3, 0.35], [6, 0.5], [9, 0.62], [12, 0.72], [15, 0.8], [18, 0.86], [21, 0.9], [24, 0.92], [27, 0.93], [30, 0.93]]
        }, {
            yAxis: 0,
            name: '产油量',
            lineWidth: 3,
            data: [[0, null], [3, 0.14], [6, 0.2], [9, 0.248], [12, 0.288], [15, 0.32], [18, 0.344], [21, 0.36], [24, 0.368], [27, 0.372], [30, 0.372]]
        }, {
            yAxis: 0,
            name: '产水量',
            lineWidth: 3,
            data: [[0, null], [3, 0.21], [6, 0.3], [9, 0.372], [12, 0.432], [15, 0.48], [18, 0.516], [21, 0.54], [24, 0.552], [27, 0.558], [30, 0.558]]
        }, {
            yAxis: 1,
            name: '产出价值',
            lineWidth: 3,
            data: [[0, null], [3, 281.66], [6, 402.37], [9, 498.94], [12, 579.41], [15, 643.79], [18, 692.08], [21, 724.27], [24, 740.36], [27, 748.41], [30, 748.41]]
        }, {
            yAxis: 2,
            name: '电费',
            lineWidth: 3,
            data: [[0, null], [3, 15], [6, 20], [9, 30], [12, 50], [15, 80], [18, 120], [21, 200], [24, 350], [27, 550], [30, 850]]
        }, {
            yAxis: 2,
            name: '原油处理成本',
            lineWidth: 3,
            data: [[0, null], [3, 1.12], [6, 1.6], [9,1.98], [12, 2.3], [15, 2.56], [18, 2.75], [21, 2.88], [24, 2.94], [27, 2.98], [30, 2.98]]
        }, {
            yAxis: 2,
            name: '作业维护成本',
            lineWidth: 3,
            data: [[0, null], [3, 2.5], [6,5 ], [9, 7.5], [12, 10], [15, 12.5], [18, 15], [21, 17.5], [24, 19], [27, 20], [30, 20]]
        }, {
            yAxis: 2,
            name: '总成本',
            lineWidth: 3,
            data: [[0, null], [3, 18.32], [6, 26.6], [9,39.48 ], [12, 62.3], [15,95.06 ], [18, 117.75], [21, 250.4], [24, 371.94], [27, 572.98], [30, 872.98]]
        }, {
            yAxis: 3,
            name: '利润',
            lineWidth: 3,
            data: [[0, null], [3, 263.34], [6, 375.77], [9, 459.46], [12, 516.21], [15, 548.73], [18, 574.33], [21, 473.87], [24, 368.42], [27, 175.43], [30, -127.57]]
        }],
        credits: {
            enabled: false
        }
